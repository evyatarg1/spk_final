...
/*This function gets a matrix and print its transpose matrix s.t the matrix will be separated by a comma, such that each row is in a line of its own*/
void print_transpose_mat(Matrix * mat)
{
    int i, j;
    for (i = 0; i < mat->rows; i++)
...
/*This function gets an array and its length, and print it s.t each value will be separated by a comma*/
void print_arr(double* arr, int n)
{
    int i;
    for (i = 0; i < n; i++)
